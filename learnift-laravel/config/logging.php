...
return [
    ...
    'channels' => [
        ...
        'papertrail' => ['driver' => 'monolog', 'level' => env('LOG_LEVEL', 'debug'), 'handler' => env('LOG_PAPERTRAIL_HANDLER', SyslogUdpHandler::class), 'handler_with' => ['host' => env('LOG_PAPERTRAIL_URL'), 'port' => env('LOG_PAPERTRAIL_PORT'), 'connectionString' => 'tls://'.env('LOG_PAPERTRAIL_URL', '').':'.env('LOG_PAPERTRAIL_PORT', 0)], 'processors' => [PsrLogMessageProcessor::class]],
